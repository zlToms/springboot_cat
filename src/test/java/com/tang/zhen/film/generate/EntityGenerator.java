package com.tang.zhen.film.generate;
...
public class EntityGenerator {
    ...
    private String outputDir = "D:\\my\\springboot_film\\next_film\\src\\main\\java";
    // 生成类的作者
    private String author = "toms";
    // 数据源相关配置
    ...
    // DAO的包路径
    private String daoPackage = "com.tang.zhen.film.dao";
    // 待生成的表名，注意是覆盖更新
